...
<body class="form " style="background-image: url('https://blksumenep.com//assets/img/blk.jpg'); background-size: cover;">
    <div class="form-form ">
        <div class="">
            <div class="form-form-wrap my-auto ">
                <div class="d-flex justify-content-center p-5 rounded-lg " style="background-color: rgba(255, 255, 255, 0.8);">
                    <div class="form-content ">
                        <h1 class="">Log In <a href=""><span class="brand-name">Seleksi Online</span></a>
                        </h1>
                        <form action="{{ url('/login') }}" method="POST" class="text-left">
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input type="text" id="username" name="email" type="text"
                                ...
                                <div id="password-field" class="field-wrapper input mb-2">
                                    ...
                                    <input type="password" id="password" name="password" type="password"
                                        class="form-control" placeholder="Masukkan Tanggal Lahir Anda" required>
                                </div>
