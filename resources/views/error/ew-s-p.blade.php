        ...
        $("input[type=radio]").click(function() {
            ...
            $(this).is(":checked") ? ($("#" + e).removeClass("btn-white"), $("#" + e).addClass("btn-warning"),
                a = $(this).data("id_pg"), $.ajax({
                    ...
                    async: !0,
                    url: "{{ url('/peserta/ragu_pg') }}",
                    success: function(a) {
                        console.log(a)
                    }
                })) : ($("#" + e).removeClass("btn-warning"), $("#" + e).hasClass("btn-info") ? $("#" + e)
                .removeClass("btn-white") : $("#" + e).addClass("btn-white"), a = $(this).data("id_pg"), $
                .ajax({
                    headers: {
                        "X-CSRF-TOKEN": "{{ csrf_token() }}"
                    },
            ...
            var a = $("input[name=currentQuestionNumber]").val(),
                ...
                a = "ragus-" + e;
            e <= "{{ $ujian->detailujian->count() }}" && ($(".ragus").addClass("hidden"), $("." + a)
                .removeClass("hidden"))
